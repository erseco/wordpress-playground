...
// runtime extractor (reject "..", strip leading "/", drop "." segments) so the
 ...
 * unsafe paths are skipped. The sort is a stable byte-wise comparison on the
...
export function createUstarTar(entries, options = {}) {
	const { mtime = 0, uid = 0, gid = 0, mode = 0o644, dirMode = 0o755 } =
		options;
	const chunks = [];
