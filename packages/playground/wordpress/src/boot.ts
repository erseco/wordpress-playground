...
export interface BootWordPressOptions {
	 ...
	 * Either a solid `tar.zst` (minified Playground bundle, stream-extracted) or
	 * a ZIP (wordpress.org release, custom URL, GitHub artifact); the format is
	 * detected from the bundle's magic bytes.
	 */
