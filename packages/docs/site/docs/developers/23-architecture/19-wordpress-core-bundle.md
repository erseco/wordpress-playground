...
comparison, per-engine browser numbers, methodology, and design details are in
[the tar.zst design notes](/developers/architecture/wordpress-core-bundle-tar-zst-design).
